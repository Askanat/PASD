 ...
 * et on termine par un passage à la ligne
...
/*!
 * Affiche toutes les valeurs contenues dans un arbre selon un parcours préfixe avec en plus des parenthèses et des virgules pour montrer la structure arborescente.
 ...
 * Le parcours est sur le premier élément (s'il existe)
 ...
 * pour un fils
 * pour un frère
 * pour un frère de premier ancêtre qui en a un
 * \param p parcours à avancer d'une position
 * \pre p ne doit pas être NULL
 */
